...
def normalize_backend_report(report, fallback_message=""):
    ...
    return {
        ...
        "suggested_deeper_scope": report.get("suggested_deeper_scope") or [],
        "needs_clarification": bool(report.get("needs_clarification", False)),
        "clarifying_question": str(report.get("clarifying_question") or ""),
